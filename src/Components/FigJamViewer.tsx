...
import { ArrowLeft, ChevronDown, Info, Search, Sparkles, ShoppingBag } from "lucide-react";
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="md:hidden">
                <MobileCarousel>
                  {[
                    <div
                      key="experience1"
                      className="bg-card/80 backdrop-blur-lg rounded-2xl border border-pink-500/20 overflow-hidden group hover:border-pink-500/40 transition-all duration-300"
                    >
                      <div className="p-8">
                        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-pink-500/20 to-purple-500/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="hidden md:grid md:grid-cols-3 gap-8">
                <div className="bg-card/80 backdrop-blur-lg rounded-2xl border border-pink-500/20 overflow-hidden group hover:border-pink-500/40 transition-all duration-300">
                  <div className="p-8">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-pink-500/20 to-purple-500/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                      <Search className="w-7 h-7 text-pink-400" />
                    </div>
